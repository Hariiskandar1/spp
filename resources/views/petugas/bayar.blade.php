...
<div class="container-fluid">
    ...
    {{-- blade --}}
        <div class="row">
            <div class="col-md-5">
            <form method="POST" action="{{ url('/storePetugas') }}">
                    @csrf
                        <!-- DataTales Example -->
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <input type="number" hidden class="form-control mb-2" id="id_petugas" name="id_petugas" value="{{ $dataauth->id }}">
                                ...
                                <div class="d-sm-flex justify-content-between mb-1 mt-3">
                                    <a href="{{ route('petugasStudent.index') }}" class="btn btn-secondary">Batal</a>
                                    <?php $no=1;?>
                                    <?php $total=0;?>
